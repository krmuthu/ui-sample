...
```jsx
import { DateTimePicker } from 'clipper-ui';
...
```jsx
<DateTimePicker variant="primary">Primary DateTimePicker</DateTimePicker>
<DateTimePicker variant="secondary">Secondary DateTimePicker</DateTimePicker>
```

### Sizes

```jsx
<DateTimePicker size="sm">Small DateTimePicker</DateTimePicker>
<DateTimePicker size="md">Medium DateTimePicker</DateTimePicker>
<DateTimePicker size="lg">Large DateTimePicker</DateTimePicker>
```

### Disabled State

```jsx
<DateTimePicker disabled>Disabled DateTimePicker</DateTimePicker>
```

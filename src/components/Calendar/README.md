...
```jsx
import { Calendar } from 'clipper-ui';
...
<Calendar variant="secondary">Secondary Calendar</Calendar>
```
...
<Calendar size="md">Medium Calendar</Calendar>
...
```jsx
<Calendar disabled>Disabled Calendar</Calendar>
```

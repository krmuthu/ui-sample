...
```jsx
<Toast size="sm">Small Toast</Toast>
<Toast size="md">Medium Toast</Toast>
<Toast size="lg">Large Toast</Toast>
```

### Disabled State

```jsx
<Toast disabled>Disabled Toast</Toast>
```
